# -*- coding: utf-8 -*-
"""blogger-parser.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1sRyyQhc1CY-ussrSUBRIJNBZsFsI9P_W
"""
...
CONFIG = {
    'API_KEY': 'AIzaSyDIkKj164eip83VeGB7r-OPJAsPJHGwS2Y',
...
names = df["blogger_name"].dropna().tolist()

spreadsheet_url = "https://docs.google.com/spreadsheets/d/1dEVCjoT034dWzd2rmP2v7D00WOCi3aq1_-HGD2qf9kc/edit?gid=719843448#gid=719843448"
sh = gc.open_by_url(spreadsheet_url)
ws = sh.worksheet("Bloggers")

existing = ws.col_values(2)
next_row = len(existing) + 1
start_cell = f"B{next_row}"

ws.update(start_cell, [[n] for n in names])

print("OK, добавлено:", len(names))
